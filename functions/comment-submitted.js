...
exports.handler = function(event, context, callback) {
    ...
    if (queryStringParameters["IAMSORUSH_COMMENT_FUNCTION_AUTH"] !== process.env.IAMSORUSH_COMMENT_FUNCTION_AUTH) {
        return console.log("IAMSORUSH_COMMENT_FUNCTION_AUTH query param incorrect");
    }
